...
window.appData = {
  ...
  state: {
    ...
    activities: [
      { id: dataNextId(), category: "Walking", icon: "🚶", title: "Morning Walk at Carlton Gardens", location: "Carlton Gardens, Melbourne · 1.2 km away", date: "Wednesday, 20 Aug · 8:00 am", price: "Free", copy: "A friendly guided morning walk through the gardens. All fitness levels welcome. Walking poles provided.", access: "Flat paths, wheelchair accessible", organiser: "Melbourne City Council", saved: false, joined: false, lat: -37.80611, lng: 144.97028 },
      { id: dataNextId(), category: "Gardening", icon: "🌱", title: "Community Gardening Group", location: "Fitzroy Community Garden · 2.4 km away", date: "Saturday, 23 Aug · 10:00 am", price: "Free", copy: "Grow vegetables and flowers with friendly neighbours. No experience needed - tools and gloves provided.", access: "Ground level, seated options available", organiser: "Fitzroy Community Hub", saved: false, joined: false, lat: -37.7984, lng: 144.9785 },
      { id: dataNextId(), category: "Library event", icon: "💻", title: "Library Digital Skills Workshop", location: "Melbourne City Library · 0.9 km away", date: "Thursday, 21 Aug · 2:00 pm", price: "Free", copy: "Learn how to use your phone and tablet safely. Friendly staff help at your own pace. Bring your device.", access: "Fully accessible, lift available", organiser: "State Library Victoria", saved: false, joined: false, lat: -37.8076, lng: 144.9624 },
      { id: dataNextId(), category: "Coffee group", icon: "☕", title: "Seniors Coffee Morning", location: "Brunswick Community Centre · 3.1 km away", date: "Friday, 22 Aug · 10:30 am", price: "Low cost - $3 donation", copy: "A warm and welcoming morning tea with other seniors. Chat, play cards, or simply enjoy the company.", access: "Accessible entrance, seating provided", organiser: "Brunswick Seniors Network", saved: false, joined: false, lat: -37.7667, lng: 144.9628 },
      { id: dataNextId(), category: "Health workshop", icon: "🤸", title: "Gentle Exercise Class", location: "Northcote Leisure Centre · 4.0 km away", date: "Tuesday & Friday · 9:30 am", price: "Low cost - $5 per session", copy: "Low-impact stretching and gentle movement for older adults. Instructor led, suitable for all abilities.", access: "Accessible venue, chairs available", organiser: "Northcote Leisure Centre", saved: false, joined: false, lat: -37.7722, lng: 144.9994 },
    ],
    activityFilter: "All",
